  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
      <div className="fade-in-up mb-8 flex items-end justify-between gap-4">
        ...
        <Link href="/services" className="text-sm font-semibold text-fog transition duration-300 hover:text-burgundyAccent">
          Full service menu
        </Link>
      </div>
      <div className="grid gap-4 lg:grid-cols-6">
        {services.map((service, index) => (
          <button
            ...
            className={`fade-in-up rounded-2xl border border-line bg-[#141414] p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-burgundyAccent/45 hover:bg-burgundy/10 hover:shadow-lg lg:col-span-2 ${
