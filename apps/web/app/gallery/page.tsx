      ...
      <section className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
        ...
        <div className="mt-8 grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-3 lg:grid-cols-4">
          {visibleItems.map((item, index) => (
            <article
              key={item.id}
              className="fade-in-up group relative aspect-[4/5] overflow-hidden rounded-xl border border-black/10 bg-ink text-white transition duration-300 hover:-translate-y-1 hover:shadow-xl sm:rounded-2xl"
